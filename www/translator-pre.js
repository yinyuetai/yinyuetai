...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainView = __webpack_require__(171);
	$(function () {
	    // 入口视图
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DetailView = __webpack_require__(172);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatView = __webpack_require__(173);
	var View = BaseView.extend({
	    el: '.videoWin',
	    events: {
	    },
	    ...
	    afterMount: function() {
	        //  获取findDOMNode DOM Node
	        this.videoWin = __webpack_require__(175);
	    },
	    ready: function() {
	        //  初始化
	        var self = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var View = BaseView.extend({
	    ...
	    beforeMount: function() {
	        ...
	        this._preListCon = this.$el.find('.preListCon');
	        this._preList = this.$el.find('.preListCon .list');
	    },
	    afterMount: function() {
	        //  获取findDOMNode DOM Node
	        this.preItemTpl = __webpack_require__(174);
	    },
	    ready: function() {
	        //  初始化
	        var self = this;
	        this.onEvents();
	        this.listenTo(this.model, 'change:preSTranslator', this.renderChat)
	    },
	    onEvents: function() {
	        var self = this;
	        ...
	        this.on('events:preSTranslator', function() {
	            this.preSTranslator();
	        });
	    },
	    beforeDestroy: function() {
	    ...
	    renderChat : function () {
	        var list = this.model.get('preSTranslator');
	        var html = this.compileHTML(this.preItemTpl,{list:list});
	        this._preList.html(html);
	        // this._preListCon.show();
	        this._preListCon.scrollTop(100000);
	    }
	});
...
//# sourceMappingURL=translator-pre.js.map